...
// addPlayersSettlementOnNone(player00,node00); 
// addPlayersSettlementOnNone(player00,node01); 
// addPlayersSettlementOnNone(player00,node02); 

// addPlayersSettlementOnNone(player01,node03); 
// addPlayersSettlementOnNone(player01,node04); 
// addPlayersSettlementOnNone(player01,node05); 
// addPlayersSettlementOnNone(player01,node06); 

// addPlayersCityToNode(player02,node07);
// addPlayersCityToNode(player02,node08);
// addPlayersCityToNode(player02,node09);
// addPlayersCityToNode(player02,node10);
